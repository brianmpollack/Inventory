...
require_once('Controller/create_location.php');
        ...
        <div class="container">
            ...
            <form method="post" action="">
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="name" name="name" aria-describedby="name_help" placeholder="Name" required>
                    <small id="name_help" class="form-text text-muted"></small>
                </div>
                <button type="submit" class="btn btn-primary" name="submit" value="new-location">Save</button>
            </form>
        </div>
