        ...
        <div class="container">
            ...
            <form method="post" action="">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="description" name="description" aria-describedby="description_help" placeholder="Description" required>
                    <small id="description_help" class="form-text text-muted"><!--Short description of item.--></small>
                </div>
                <div class="form-group">
                    <label for="model">Model Number</label>
                    <input type="text" class="form-control" id="model" name="model" aria-describedby="model_help" placeholder="Model Number">
                    <small id="model_help" class="form-text text-muted"><!--Model number of item.--></small>
                </div>
                <div class="form-group">
                    <label for="serial">Serial Number</label>
                    <input type="text" class="form-control" id="serial" name="serial" aria-describedby="serial_help" placeholder="Serial Number">
                    <small id="serial_help" class="form-text text-muted"><!--Serial number of item.--></small>
                </div>
                <div class="form-group">
                    <label for="mac_address">MAC Address</label>
                    <input type="text" class="form-control" id="mac_address" name="mac_address" aria-describedby="mac_address_help" placeholder="MAC Address">
